...
;		value:=ReadMemoryTxt(myAOBaddresshex,"asdasd.txt - Notepad")
;		msgbox, % value 
				
		value := ReadMemoryTxt(myAOBaddresshex,"ahk_exe NOTEPAD.EXE")
		msgbox, % value 
		value := WriteMemory("1111",myAOBaddresshex,"8765.txt")
...
return
    ...
    ChangeProcessAddrValue(win_id, addr, addr_value, addr_offset = 0, value_size = 4)
    {
        if (win_id > 0)
        {
            addr += addr_offset
            ...
            DllCall("CloseHandle", "int", OperaHandle)
        }

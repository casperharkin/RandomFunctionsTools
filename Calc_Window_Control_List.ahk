...
XA_Load(A_Desktop . "\CalcContList.xml" )
...
/*
Calc_Window_Control_List := {}

q::
Loop 62 {

ControlGetText, SubObj, Edit9, Accessible Info Viewer
SubObj := StrReplace(SubObj, A_Space, "_")

ControlGetText, Name, Edit9, Accessible Info Viewer
ControlGetText, Role, Edit11, Accessible Info Viewer
ControlGetText, Location, Edit17, Accessible Info Viewer

Calc_Window_Control_List.Insert(SubObj, {Name:name,Role:Role,Location:Location})
sleep 500
WinActivate, Acc Structure
Send {Down}
}
